...
do
	...
	do
		...
		do
			./build/src/host_memory $(expr $INSIZE / $THREAD) $INSIZE $OP >> /tmp/benchmark
		done
...
do
	...
	do
		...
		for i in $(seq 1 $NORUNS)
		do
			./build/src/const_memory $(expr $INSIZE / $THREAD) $INSIZE $OP >> /tmp/benchmark
		done
...
do
	...
	do
		...
		for i in $(seq 1 $NORUNS)
		do
			./build/src/pinned_memory $(expr $INSIZE / $THREAD) $INSIZE $OP >> /tmp/benchmark
		done
...
do
	...
	do
		...
		for i in $(seq 1 $NORUNS)
		do
			./build/src/shared_memory $(expr $INSIZE / $THREAD) $INSIZE $OP >> /tmp/benchmark
		done
