...
run_test "EVEN CLASSIFICATION" "./build/src/even_odd" "-i example.txt -s src/even_odd.cl -m even"
run_test "ODD CLASSIFICATION" "./build/src/even_odd" "-i example.txt -s src/even_odd.cl -m odd"
